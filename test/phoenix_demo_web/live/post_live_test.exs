defmodule PhoenixDemoWeb.PostLiveTest do
  ...
  describe "Index" do
    ...
    test "updates post in listing", %{conn: conn, post: post} do
      ...
      assert index_live |> element("#post-#{post.id} a", "✏️") |> render_click() =~
               "Edit Post"
    ...
    test "deletes post in listing", %{conn: conn, post: post} do
      ...
      assert index_live |> element("#post-#{post.id} a", "❌") |> render_click()
      assert has_element?(index_live, "#post-#{post.id}[class~=hidden]")
    end
  end
